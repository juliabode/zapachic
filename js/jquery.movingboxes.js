...
jQuery(document).ready(function($) {
	...
	$.movingBoxes = function(el, options){
		...
		base.setSizes = function(flag){
            ...
            base.heights = base.$panels.css('height','330').map(function(i,e){ return $(e).outerHeight(true); }).get();
			...
			base.$el.css({
				...
				//'padding-left' : 20//(base.width - base.curWidth) / 2
			});
		...
		base.change = function(curPanel, callback, flag){
			...
			if (base.curPanel !== curPanel && (!base.currentlyMoving || !base.initialized)) {
				...
				base.$curPanel = base.$panels.eq(curPanel - base.adj);
                       leftValue = base.$curPanel.position().left - (base.width - base.curWidth) / 4 + base.padding;
